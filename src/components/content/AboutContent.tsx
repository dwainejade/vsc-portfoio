    ...
    <div className="p-6 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-200 leading-relaxed">
          I discovered that software development wasn't just a career but a world of limitless possibilities where you can create something from nothing. It's a field that allows my creative and logical sides to work in harmony, building solutions that matter. For the past three years at StrongMind, I've been crafting educational tools that help K-12 students engage with learning in new ways. In my free time, I've developed a particular passion for 3D web animations and simulations using Three.js, creating interactive experiences that blur the line between technology and art.
        </p>
      </section>
